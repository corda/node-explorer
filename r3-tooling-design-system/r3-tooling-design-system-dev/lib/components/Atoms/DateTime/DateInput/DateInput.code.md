...
| :----------- | :-------------------- | :-------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| label        | string                | yes       |                                                                                                                                                                                                                                            |
| value        | Date/null             | yes       | The value is parsed as a dateString for the needs of the input field. When the user selects a new date, the onChange event is an array with a single Date object, which is the selected date.                                              |
