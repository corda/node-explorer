          ...
          <div className="center-container">
            <div>
              ...
              <Grid container style={{marginTop: "20px"}}>
                <Grid item xs={6}>
                    <TextField label="Hostname" value={this.state.hostName} onChange={e => this.setState({hostName: e.target.value})} 
                ...
                <Grid item xs={6}>
                    <TextField label="Port" type="number" onChange={e => this.setState({port: e.target.value})} 
                ...
                <Grid container>
                  <Grid item xs={12}>
                    <TextField label="Username" fullWidth  onChange={e => this.setState({username: e.target.value})}
